...
var CreateOpcionDto = (function () {
  ...
  return (
    (_a = /** @class */ (function () {
      function CreateOpcionDto() {
        this.texto = __runInitializers(this, _texto_initializers, void 0); // Texto de la opción
        this.numero =
          (__runInitializers(this, _texto_extraInitializers),
          __runInitializers(this, _numero_initializers, void 0)); // Número que representa el orden o posición de la opción
        __runInitializers(this, _numero_extraInitializers);
      }
      return CreateOpcionDto;
    })()),
    (function () {
      var _metadata =
