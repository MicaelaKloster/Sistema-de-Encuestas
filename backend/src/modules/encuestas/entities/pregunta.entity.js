...
var encuesta_entity_1 = require('./encuesta.entity');
// Importación de la entidad relacionada "Opcion"
var opcion_entity_1 = require('./opcion.entity');
  ...
  var Pregunta = (_classThis = /** @class */ (function () {
    function Pregunta_1() {
      ...
      this.tipo =
        ...
        __runInitializers(this, _tipo_initializers, void 0)); // Especifica el tipo de respuesta permitido para la pregunta
      this.encuesta =
        (__runInitializers(this, _tipo_extraInitializers),
        __runInitializers(this, _encuesta_initializers, void 0)); // Referencia a la encuesta a la que pertenece esta pregunta
      this.opciones =
        (__runInitializers(this, _encuesta_extraInitializers),
        __runInitializers(this, _opciones_initializers, void 0)); // Lista de opciones asociadas a la pregunta
  ...
  (function () {
    ...
    _tipo_decorators = [
      (0, typeorm_1.Column)({
        ...
        default: tipos_respuesta_enum_1.TiposRespuestaEnum.ABIERTA, // Valor por defecto para registros existentes
      }),
    ];
