...
var opciones_service_1 = require('./services/opciones.service');
var opciones_controller_1 = require('./controllers/opciones.controller');
var OpcionesModule = (function () {
  ...
  var _classThis;
  var OpcionesModule = (_classThis = /** @class */ (function () {
    function OpcionesModule_1() {}
    return OpcionesModule_1;
  })());
  __setFunctionName(_classThis, 'OpcionesModule');
  (function () {
    var _metadata =
    ...
    OpcionesModule = _classThis = _classDescriptor.value;
    if (_metadata)
  ...
  return (OpcionesModule = _classThis);
})();
