...
var respuesta_abierta_entity_1 = require('./respuesta-abierta.entity');
var respuesta_opcion_entity_1 = require('./respuesta-opcion.entity');
  ...
  (function () {
    ...
    _respuestasAbiertas_decorators = [
      (0, typeorm_1.OneToMany)(
        ...
        function (respuestaAbierta) {
          return respuestaAbierta.respuesta;
        },
      ),
    ];
    _respuestasOpciones_decorators = [
      (0, typeorm_1.OneToMany)(
        ...
        function (respuestaOpcion) {
          return respuestaOpcion.respuesta;
        },
      ),
    ];
    __esDecorate(
